...
export default function Poaps() {
    ...
    const extra = (
        <Space>
            ...
            <Button type="primary" onClick={() => setIsActivityModalVisible(true)}>创建活动</Button>
    ...
    return (
        <>
            ...
            <CreatePOA open={isActivityModalVisible} onOk={form.submit} onCancel={() => setIsActivityModalVisible(false)} onFinish={onContractCreate} />
